...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedUser.compareTo(Cache.getInstance().getCurrUser()) == 0) {
            ...
            presenter.updateFollowButton(selectedUser);
        }
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (followButton.getText().toString().equals(v.getContext().getString(R.string.following))) {
                    ...
                    displayToast("Removing " + selectedUser.getName() + "...");
                } else {
                    presenter.follow(selectedUser);

                    displayToast("Adding " + selectedUser.getName() + "...");
                }
    ...
    @Override
    public void displayPostStatusSuccess(String message) {
        postingToast.cancel();
    ...
    public void updateSelectedUserFollowingAndFollowers(User selectedUser) {
        presenter.updateSelectedUsersFollowingAndFollowers(selectedUser);
    }
